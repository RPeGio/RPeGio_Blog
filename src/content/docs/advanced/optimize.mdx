...
- [`@playform/compress`](/docs/integrations/others#playformcompress): HTML, CSS, JS, images minify (has problems for a while; see [GitHub Issue #55](https://github.com/RPeGio/RPeGio_Blog/issues/55))
