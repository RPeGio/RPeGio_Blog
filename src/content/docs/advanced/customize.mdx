...
1. Making sure you have the original theme code (`./packages/pure`). If yo've deleted it, download it from the [Releases](https://github.com/RPeGio/RPeGio_Blog/releases).
